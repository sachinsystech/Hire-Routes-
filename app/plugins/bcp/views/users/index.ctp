	...
	<?php echo $form->create('User', array('class' => 'filter' ,'url' => array('action' => 'index'))); ?>
		<table cellpadding="0" cellspacing="0">
			<tr>
				...
				<th><?php echo $paginator->sort('account_email');?></th>
				<th><?php echo $paginator->sort('group_id');?></th>
				<th class="actions"><?php __('Actions');?></th>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><?php echo $form->input('account_email', array('label' => false, 'div' => false)); ?></td>
		...
		foreach ($users as $user):
			...
			<tr<?php echo $class;?>>
				...
				<td>
					<?php echo $user['User']['account_email']; ?>
				</td>
				<td>
					<?php
						echo $html->link(
				...
				<td class="actions">
					<?php
					echo $databaseMenus->makeMenu($actionsMenu, 'actions', $user['User']['id'], $user['User']['account_email']);
					?>
				</td>
			</tr>
		<?php endforeach; ?>

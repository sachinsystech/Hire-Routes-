...
?>
		...
		?>
			<ul>
				<li <?php if($this->action=='newJob'||$this->action=='appliedJob'||$this->action=='jobDetail'||$this->action=='applyJob'||$this->action=='#') echo "class='active'";?>><a style="color: #000000;text-decoration: none;font-weight: normal;" href="/jobseekers/newJob"><span>My Jobs</span></a></li>

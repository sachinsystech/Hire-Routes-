					...
					success: function( data ) {
						...
						response( $.map( data, function(item) {
							...
							if(item.id === 0) {
								$("#JobseekerSettingsUniversity").parent("div").next('div.editprofile_tooltip_backround').remove();
								$("#JobseekerSettingsUniversity").parent("div").next('label').remove();
								$("#JobseekerSettingsUniversity").parent("div").after('<div class="editprofile_tooltip_backround"></div><label for="name" generated="true" class="error editprofile_tooltip_university">'+item.university_name+'</label>');
					...
					success: function( data ) {
						...
						response( $.map( data, function(item) {
							if(item.id === 0) {
								$("#JobseekerSettingsGraduateUniversity").parent("div").next('div.editprofile_tooltip_backround').remove();
								$("#JobseekerSettingsGraduateUniversity").parent("div").next('label').remove();
								$("#JobseekerSettingsGraduateUniversity").parent("div").after('<div class="editprofile_tooltip_backround"></div><label for="name" generated="true" class="error editprofile_tooltip_university">'+item.university_name+'</label>');

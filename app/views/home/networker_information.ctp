    <h1 class="title-emp"> <span class="networker-blue">Networkers:</span> Make Money by Helping People find Jobs</h1>
    <div class="infographic-buttons-container">
    	...
    	<div class="infographic-buttons-networker-active infographic-button-text"><a href="/users">GET STARTED</a></div>
    	<div class="infographic-buttons-jobseeker infographic-button-text"><a href="/jobseekerInformation">JOB SEEKER</a></div>
    </div>

  	<div class="info-networker-img">
    	<div class="info-js-text-comp">1. JOBS ARE POSTED WITH A COMMISSION</div>
